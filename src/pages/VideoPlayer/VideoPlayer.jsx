        ...
        <Container>
            <Grid.Row>
                ...
                <Grid.Column width={4}>
                    ...
                    <Scroll>
                        {fakeVideos.length > 0 && (
                            <RelatedVideos related={fakeVideos} />
                        )}
                    </Scroll>
                </Grid.Column>
            </Grid.Row>
